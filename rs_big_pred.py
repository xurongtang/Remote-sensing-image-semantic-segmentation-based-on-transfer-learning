...
def big_image_test(model_name,encoder_name,file_path,model_path,model_input_size=(256,256)):
    ...
    window_size = model_input_size[0]
...
def rs_big_pred(model_name,encoder_name,model_path,flag):
    model_szie = (512,512)
    
    test_image1 = '/home/rton/pyproj/ieee_building_extract/new_test/test_rs_image/test_image_1.tif'
    pred_mask = big_image_test(model_name,encoder_name,test_image1,model_path,model_szie)
    cv2.imwrite(test_image1.replace('.',f'_result_{flag}.'),pred_mask)

    test_image2 = '/home/rton/pyproj/ieee_building_extract/new_test/test_rs_image/test_image_2.tif'
    pred_mask = big_image_test(model_name,encoder_name,test_image2,model_path,model_szie)
    cv2.imwrite(test_image2.replace('.',f'_result_{flag}.'),pred_mask)
